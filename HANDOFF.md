...
| FATTO | P3 | Milestone 3: servizi e UI per amicizie, richieste, blocchi | `src/features/friends/`, `src/app/(social)/amici/` | — | `pnpm lint`, `pnpm typecheck`, `pnpm test` (20), `pnpm test:integration` (20) verdi |
