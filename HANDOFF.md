...
| FATTO (parziale) | P2 | Milestone 2: data di nascita opzionale + ricerca paginata dei profili | `src/features/profiles/` | — | `pnpm lint`, `pnpm typecheck`, `pnpm test` (20), `pnpm test:integration` (13) verdi |
| TODO | P2 | Milestone 2 (resto): avatar/cover con validazione e storage | `src/features/profiles/`, `prisma/` | — | Scegliere prima il backend di storage (Vercel Blob / S3 / R2) |
